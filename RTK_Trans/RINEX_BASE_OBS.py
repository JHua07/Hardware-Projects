...
def parse_obsvma_to_rinex(obsvma_data, output_file):
    ...
    try:
        ...
        # 提取历元头信息
        # 格式: #OBSVBASEA,88,GPS,FINE,2368,291726000,0,0,18,668
        ...
        header = [
            ...
            " -1326002.8281  5323044.2303  3243889.2750                  APPROX POSITION XYZ ",
            ...
            f"  {year:4d}  {month:4d}  {day:4d}  {hour:4d}  {minute:4d}  {second:6.1f}000000     GPS         TIME OF FIRST OBS    ",
            f"  {year:4d}  {month:4d}  {day:4d}  {hour:4d}  {minute:4d}  {second:6.1f}000000     GPS         TIME OF LAST OBS     ",
        ...
        with open(output_file, 'w') as f:
            ...
            f.write(f"> {year:4d} {month:02d} {day:02d} {hour:02d} {minute:02d} {second:11.7f}  0 {len(sat_order)}\n")
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python RINEX_BASE_OBS.py <input_file> <output_file>")
        sys.exit(1)
    ...
    try:
        with open(input_file, 'r') as f:
            obsvma_data = f.read().strip()
            
        print(f"Converting base station {input_file} to RINEX 3.02 format...")
        parse_obsvma_to_rinex(obsvma_data, output_file)
        print(f"Successfully created base station RINEX file: {output_file}")
